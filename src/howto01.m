...
sctr_points_path_tmp = '../data/output/input-points.mat';


fprintf("\n\n\n\n");
fprintf("-------------------------------------------------------\n");
fprintf("Synthesis at a scattered points loaded from a binary mat file\n");
fprintf("-------------------------------------------------------\n");
fprintf("\n");
fprintf("You can import scattered points also from a ""mat"" file.  " + ...
        "Let's save now the points from ""%s"" into a ""mat"" file " + ...
        """%s"" and use the new binary file to load the scattered " + ...
        "points.\n", ...
        sctr_points_path, sctr_points_path_tmp);
fprintf("\n");
sctr_points = load(sctr_points_path);
save(sctr_points_path_tmp, "sctr_points", "-v7.3");
clear sctr_points;
sctr_points_path = sctr_points_path_tmp;


point_type       = 1;  % Load evaluation points from a mat file
